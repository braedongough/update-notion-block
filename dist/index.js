...
const utils_1 = __nccwpck_require__(769);
...
var helpers_1 = __nccwpck_require__(682);
...
function run(config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield notion.blocks.update(Object.assign({ block_id: config.blockId }, config.data));
    });
}
exports.run = run;
